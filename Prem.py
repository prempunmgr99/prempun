...
\033[1;94m ┈┈┈▕▕PR_EM▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕MAGAR▏┈┈┈
...
\033[1;91m☞ Auther     : PREM BAHADUR PUN

\033[1;92m☞ Mobile No : +9779867471646

\033[1;95m☞ YouTube    : https://www.youtube.com/channel/NOOB_FF
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://www.youtube.com/channel/NOOB_FF')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/SoHagpprloverboy')
	    ...
	    psb('Mobile No +9779867471646✓')

	    psb('WellCome To PREM BAHADUR PUN')
	    ...
	    psb('Subscrib My Youtube Channel NOOB_FF✓')
